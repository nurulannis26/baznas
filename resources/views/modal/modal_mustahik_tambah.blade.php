@if (Auth::user()->pengurus_id != null)
    ...
    <div wire:ignore.self class="modal fade " id="modal_mustahik_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form wire:submit.prevent="tambah_mustahik">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>NO KK &nbsp;</label>
                                <input wire:model="kk" type="text" class="form-control"
