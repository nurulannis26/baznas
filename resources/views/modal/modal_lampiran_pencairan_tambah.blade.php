@if (Auth::user()->pengurus_id != null)
    ...
    <div wire:ignore.self class="modal fade " id="modal_lampiran_pencairan_tambah" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form wire:submit.prevent="lampiran_pencairan_tambah">
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>JUDUL &nbsp;</label>
                                <input wire:model="keterangan_lampiran_pencairan" type="text" class="form-control"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="custom-file custom-file-surat">
                                    <input type="file" wire:model="url_pencairan"
