...
<head>
    ...
    <title>Import Data Mustahik</title>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">BAZNAS Cilacap</a>
        ...
        <div class="container px-1 py-0">
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                ...
                <div class="col-12 col-md-8 col-lg-6">
                    <form method="post" enctype="multipart/form-data" action="{{ route('import_excel_mustahik') }}">
                        @csrf
                        <div class="">
                            ...
                            <input type="text" class="form-control mb-3"
                                value="{{ $data->permohonan_nomor }}" readonly>
                            <label class="form-label">Program</label>
                            <input type="text" class="form-control mb-3"
                                value=" {{ \App\Models\Permohonan::getProgram($data->program_id) }}" readonly>
                            <label class="form-label">Sub Program</label>
                            <input type="text" class="form-control mb-3"
                                value="{{ \App\Models\Permohonan::getSubProgram($data->program_id) }}" readonly>

                            <label class="form-label">Keterangan</label>
                            <input type="text" class="form-control mb-3"
                                value="{{ $data->permohonan_catatan_input }}" readonly>
