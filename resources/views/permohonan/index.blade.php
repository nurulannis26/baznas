                ...
                <div class="card ijo-atas">
                    ...
                    <div class="card-body ">
                        @if ($filter_internal == 'on')
                            <livewire:internal-pc :c_filter_daterange="$c_filter_daterange" :c_filters_staff="$c_filters_staff" :c_filters_tujuan="$c_filters_tujuan"
                                :c_filters_dispo="$c_filters_dispo" :c_filters_kc="$c_filters_kc" :c_filters_keu="$c_filters_keu" :c_filters_lpj="$c_filters_lpj"
                                :filter_internal="$filter_internal" :sub="$sub">
                            @elseif($filter_internal == '')
                                <livewire:internal-pc :filter_internal="$filter_internal" :sub="$sub">
                        @endif
                    </div>
                    {{-- end card body --}}
